...
class ResultScreen(private val mGame: downfall) : ScreenAdapter() {
    companion object {
    ...
    init {
        ...
        // 背景の準備
        val bgTexture = Texture("ss71.png")
    ...
    override fun render(delta: Float) {
        ...
        mFont.draw(mGame.batch, "You are downfall...", 0f, GUI_HEIGHT / 2 - 40, GUI_WIDTH, Align.center, false)
        mGame.batch.end()
